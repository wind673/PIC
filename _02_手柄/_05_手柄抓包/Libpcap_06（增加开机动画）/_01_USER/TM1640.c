...
void TM1640_Show_Hex(  unsigned int Numbers)
{
  //数码管位数（数码管排列从左往右 依次 0 ~ 3）
    TM1640_Writer_Dates(3,LED_Number[Numbers%16]); Numbers/=16;               //数码管0
    TM1640_Writer_Dates(2,LED_Number[Numbers%16]); Numbers/=16;               //数码管1 
    TM1640_Writer_Dates(1,LED_Number[Numbers%16]); Numbers/=16;               //数码管2
    TM1640_Writer_Dates(0,LED_Number[Numbers%16]);                            //数码管3
}
