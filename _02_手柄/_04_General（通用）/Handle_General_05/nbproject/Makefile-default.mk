...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Handle_General_05.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
# Source Files
SOURCEFILES=_01_USER/main.c _01_USER/My_Delay.c _01_USER/Key.c _01_USER/My_USART.c _01_USER/My_Timer.c _01_USER/GPIO.c _01_USER/TM1640.c _01_USER/My_ADC.c _01_USER/Run.c _01_USER/Handle_Protocol.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Handle_General_05.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_01_USER/Handle_Protocol.p1: _01_USER/Handle_Protocol.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_01_USER" 
	@${RM} ${OBJECTDIR}/_01_USER/Handle_Protocol.p1.d 
	@${RM} ${OBJECTDIR}/_01_USER/Handle_Protocol.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"F:/Program Files (x86)/Microchip/xc8/v1.34/include/plib" -I"F:/Program Files (x86)/Microchip/xc8/v1.34/include/legacy" -I"F:/Program Files (x86)/Microchip/xc8/v1.34/include" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" 每leanp1    -o${OBJECTDIR}/_01_USER/Handle_Protocol.p1  _01_USER/Handle_Protocol.c 
	@-${MV} ${OBJECTDIR}/_01_USER/Handle_Protocol.d ${OBJECTDIR}/_01_USER/Handle_Protocol.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_01_USER/Handle_Protocol.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
