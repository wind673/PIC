...
//    {
//        if( gs_Menu.Lock == 1)  gs_Switch.Demagnet = 1;//（已锁）菜单下才能退磁
//        Key_ResetFSM();  //读完组合按键，则其他按键皆无效
//    }
//    
//    /* 组合按键4,6(解锁) ---------------------------*/   
//    if ( gs_Local_Key_User.key_group == KEY_4_6 && gs_Local_Key_User.key_group_state ==  KEY_hold ) 
//    {
//        gs_Menu.Lock = 0; //解锁
//        Key_ResetFSM();  //读完组合按键，则其他按键皆无效
//    }
//    
//    /* 按键1（确认）-----------------------------*/  
//    if(gs_Local_Key_User.a_key_state[1-1] == KEY_short) 
//    if( gs_Menu.Lock == 0 )
//    {
//        if( gs_Menu.Level == 1) gs_Menu.Level = 2;
//        
//        else if( gs_Menu.Level == 2) gs_Menu.Level = 3;  
//       
//        else if( gs_Menu.Level == 3)
//        if( gs_Menu.Mune[1] == Mune1_P )
//        {
//            gs_Menu.Level = 4;
//        }
//        else  {gs_Menu.Level = 0; gs_Menu.Lock = 1;}
//        
//    }
//    
//    /* 按键2（无）--------------------------------*/  
//    
//    /* 按键3（返回） -----------------------------*/  
//    if(gs_Local_Key_User.a_key_state[3-1] == KEY_short) 
//    {
//        if( gs_Menu.Lock == 0 )
//        {
//            if(gs_Menu.Level == 2)   gs_Menu.Level = 1;//返回上一级菜单
//            else if(gs_Menu.Level == 3)   gs_Menu.Level = 2;//返回上一级菜单
//            else if(gs_Menu.Level == 4)   gs_Menu.Level = 3;//返回上一级菜单
//            else {gs_Menu.Level = 0; gs_Menu.Lock = 1;}
//        }
//    }
//                            
//    /* 按键4（充磁,+）-----------------------------*/   
//    if(gs_Local_Key_User.a_key_state[4-1] == KEY_short||gs_Local_Key_User.a_key_state[4-1] == KEY_hold) 
//    {
//        if( gs_Menu.Level == 1 ) 
//        {
//            if( gs_Menu.Mune[1] == Mune1_P ) gs_Menu.Mune[1] = Mune1_F; 
//            else gs_Menu.Mune[1] = Mune1_P;  
//        }
//        
//        if( gs_Menu.Level == 2 )
//        {
//            if( gs_Menu.Mune[2] == Mune2_Switch ) gs_Menu.Mune[2] = Mune2_Magnet;
//            else if( gs_Menu.Mune[2] == Mune2_Magnet ) gs_Menu.Mune[2] = Mune2_Demagnet;
//            else gs_Menu.Mune[2] = Mune2_Switch;
//        }
//        
//        if( gs_Menu.Level == 3 )
//        {
//            gs_Menu.Mune[3] =(gs_Menu.Mune[3] + 1)%MAGNET_CH_NUMBER; //通道选择
//        }
//        
//        if( gs_Menu.Level == 4 )
//        {
//            if( gs_Menu.Mune[2] == Mune2_Magnet)
//            gs_ComData.a_Magnet_Strength[gs_Menu.Mune[3]] = (gs_ComData.a_Magnet_Strength[gs_Menu.Mune[3]]+1)%16;//充磁、退磁强度设置
//            
//            if( gs_Menu.Mune[2] == Mune2_Demagnet)
//            gs_ComData.a_Demagnet_Strength[gs_Menu.Mune[3]] = (gs_ComData.a_Demagnet_Strength[gs_Menu.Mune[3]]+1)%16;//充磁、退磁强度设置
//            
//        }
//    }
//    
...
//            
//    /* 按键5（安全,锁定）保持长按 -------------------*/  
//    if(gs_Local_Key_User.a_key_state[5-1] == KEY_hold)                                                                                      
//    {gs_Menu.Lock = 1; gs_Menu.Level = 0;}//锁定，返回0级（锁定）菜单
//            
//    /* 按键6（退磁,-）-----------------------------*/  
//    if(gs_Local_Key_User.a_key_state[6-1] == KEY_short||gs_Local_Key_User.a_key_state[6-1] == KEY_hold) 
//    {
//        if( gs_Menu.Level == 1 ) 
//        {
//            if( gs_Menu.Mune[1] == Mune1_P ) gs_Menu.Mune[1] = Mune1_F; 
...
//        if( gs_Menu.Level == 2 )
//        {
//            if( gs_Menu.Mune[2] == Mune2_Demagnet ) gs_Menu.Mune[2] = Mune2_Magnet;
//            else if( gs_Menu.Mune[2] == Mune2_Magnet ) gs_Menu.Mune[2] = Mune2_Switch;
//            else gs_Menu.Mune[2] = Mune2_Demagnet;
//        }
//        
//        if( gs_Menu.Level == 3 )
//        {
